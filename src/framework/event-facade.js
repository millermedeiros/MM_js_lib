...
(function(){
	...
	//TODO: maybe change the structure to a custom Event Object that abstracts the DOM Events instead of a Facade (I think it's a better approach - easier to use and will be more similar to the W3C standard)
